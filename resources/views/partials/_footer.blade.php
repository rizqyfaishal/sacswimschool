    ...
    <div class="container">
        <div class="row except">
            <div class="columns four">
                ...
                <p >Sailfish Aquatic Club (SAC) merupakan kursus renang pertama yang menggabungkan konsep
            ...
            <div class="columns four">
                ...
                <ul class="program">
                    ...
                    <li><a href="#">SAC Swimming Fit</a></li>
                    <li><a href="#">SAC Swimming Pro</a></li>
                    <li><a href="#">Kurikulum</a></li>
                    <li><a href="#">Instruktor (Trainer)</a></li>
                </ul>
            </div>
        </div>
    </div>
